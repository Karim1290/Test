...
int Number_Users   =6; //Anzahl der namentlich bekannten User


long Adminlist[]    = {331260, 2312360, 2234520, 188619590};
String KnownUsers[] = {"2461320.Mandorf", "2234520.Stoll", "188619590.Admincard" ,"331260.Hugger" ,"572260.Kessler" , "1040850.van der Will"};
...
void setup() 
{
  ...
  lcd.setCursor(5, 2);
  lcd.print("SILOCK 2.3");            //Produktnamen und aktuellen Version
  delay(1000);
