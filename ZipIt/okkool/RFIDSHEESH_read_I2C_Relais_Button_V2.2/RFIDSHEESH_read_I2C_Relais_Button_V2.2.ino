...
LiquidCrystal_I2C lcd(0x27, 20, 4); //Legt die Adresse für ein LCD mit 20 Zeichen und 4 Zeilen fest 0x3F fest 
...
int Number_Users   =5; //Anzahl der namentlich bekannten User


long Adminlist[]    = {331260, 2312360, 2234520};
String KnownUsers[] = {"2461320.Mandorf", "2234520.Stoll", "331260.Hugger" ,"572260.Kessler" , "1040850.van der Will"};
